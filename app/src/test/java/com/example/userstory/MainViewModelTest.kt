...
class MainViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        val dummyQuote = DataDummy.generateDummyListItemStory()
        ...
        val actualUserStory: PagingData<ListStoryItem> = mainViewModel.story.getOrAwaitValue()
        ...
        differ.submitData(actualUserStory)
